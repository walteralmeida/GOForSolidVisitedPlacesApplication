...
{
    public class CountryDataProviderDispatcher : IDataProviderDispatcher<CountryDataObject>
    {
		[Dependency]   
        ...
        public void DispatchForEntityCollection(IEnumerable<CountryDataObject> entities, List<string> includes, IObjectsDataSet context, Dictionary<string, object> parameters, bool skipSecurity = false)
        {
			// Remember includes we've already dispatched so as to avoid multiple data fetches
			var dispatched = new HashSet<string>();
