...
{	
	/// <summary>
	/// ApiTests class for the entity 'Country'.
	/// </summary>
	[TestFixture]
	[Category("Generated_ApiTests")]
	public class CountryTestsApi
	{
		static readonly string appUrl = APITestManager.getApiUrl() + "country/";

	    [OneTimeSetUp]
        public void TestFixtureInit()
        {
			ApplicationSettings.InitializeContainer(Solid.ServiceLayer.Container.Initialize());
			//APITestManager.executeSQLFile("Country");
        }
        ...
        [Test, TestCaseSource("CountryPostData")]
        ...
        [Test, TestCaseSource("CountryGetData")]
        public void CountryGetTest(IDictionary testData)
        {
			#region Arrange
        ...
        [Test, TestCaseSource("CountryDeleteData")]
        public void CountryDeleteTest(IDictionary testData)
        {
			#region Arrange
        ...
        [Test, TestCaseSource("CountryGetCollectionData")]
        public void CountryGetCollectionTest(IDictionary testData)
        {
			#region Arrange
        ...
        [Test, TestCaseSource("CountryCountData")]
        public void CountryCountTest(IDictionary testData)
        {
			#region Arrange
		...
		public static IEnumerable<TestCaseData> CountryPostData
        {
			get{ return TestCaseSourceManager.PrepareTestCaseData("Country", "Post"); }
        }

		public static IEnumerable<TestCaseData> CountryGetData
        {
			get{ return TestCaseSourceManager.PrepareTestCaseData("Country", "Get"); }
        }

		public static IEnumerable<TestCaseData> CountryDeleteData
		{
			get{ return TestCaseSourceManager.PrepareTestCaseData("Country", "Delete"); }
        }

		public static IEnumerable<TestCaseData> CountryGetCollectionData
		{
			get{ return TestCaseSourceManager.PrepareTestCaseData("Country", "GetCollection"); }
        }

		public static IEnumerable<TestCaseData> CountryCountData
		{
			get{ return TestCaseSourceManager.PrepareTestCaseData("Country", "Count"); }
		}
	}
}