...
{	
	/// <summary>
	/// ApiTests class for the entity 'PlaceToLocation'.
	/// </summary>
	[TestFixture]
	[Category("Generated_ApiTests")]
	public class PlaceToLocationTestsApi
	{
		static readonly string appUrl = APITestManager.getApiUrl() + "placetolocation/";

	    [OneTimeSetUp]
        public void TestFixtureInit()
        {
			ApplicationSettings.InitializeContainer(Solid.ServiceLayer.Container.Initialize());
			//APITestManager.executeSQLFile("PlaceToLocation");
        }
        ...
        [Test, TestCaseSource("PlaceToLocationPostData")]
        public void PlaceToLocationPostTest(IDictionary testData)
        {
			#region Arrange

			var currentEntity = new PlaceToLocationDataObject();
			var include = "";
			var token = "";
			...
			{
				currentEntity.LocationURI = testData["LocationURI"].ToString().Trim() != null ? testData["LocationURI"].ToString().Trim().ToString() : null;
        ...
        [Test, TestCaseSource("PlaceToLocationGetData")]
        ...
        [Test, TestCaseSource("PlaceToLocationDeleteData")]
        ...
        [Test, TestCaseSource("PlaceToLocationGetCollectionData")]
        public void PlaceToLocationGetCollectionTest(IDictionary testData)
        {
			#region Arrange
        ...
        [Test, TestCaseSource("PlaceToLocationCountData")]
        public void PlaceToLocationCountTest(IDictionary testData)
        {
			#region Arrange
		...
		public static IEnumerable<TestCaseData> PlaceToLocationPostData
        {
			get{ return TestCaseSourceManager.PrepareTestCaseData("PlaceToLocation", "Post"); }
        }

		public static IEnumerable<TestCaseData> PlaceToLocationGetData
        {
			get{ return TestCaseSourceManager.PrepareTestCaseData("PlaceToLocation", "Get"); }
        }

		public static IEnumerable<TestCaseData> PlaceToLocationDeleteData
		{
			get{ return TestCaseSourceManager.PrepareTestCaseData("PlaceToLocation", "Delete"); }
        }

		public static IEnumerable<TestCaseData> PlaceToLocationGetCollectionData
		{
			get{ return TestCaseSourceManager.PrepareTestCaseData("PlaceToLocation", "GetCollection"); }
        }

		public static IEnumerable<TestCaseData> PlaceToLocationCountData
		{
			get{ return TestCaseSourceManager.PrepareTestCaseData("PlaceToLocation", "Count"); }
		}
	}
}