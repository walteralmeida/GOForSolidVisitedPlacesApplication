	...
	Solid.Web.ViewModels.LocationFormViewModel = function(controller, $formContainer, sDataBindRoot, $popupContainer, parentContextId, options) {
      ...
      this.Commands.IsCreateNewCommandVisible = ko.pureComputed(function () {
		...
		this.isShowEditCountryPopupEnabled = function () {
			return self.LocationObject().getCountry() != null;
		};

		this.showEditCountryPopup = function () {
			var objectToShow = self.LocationObject().getCountry();
			...
			GO.log("LocationForm", "Opening lookup popup on CountryForm");
		};
		...
		this.onSelectedCountryChanged = function (selectedObject)  {
			...
			if (selectedObject == null) {
				self.LocationObject().Data.CountryURI(null);
				self.LocationObject().Data._country_NewObjectId(null); 
			}
			else if (selectedObject.Data.IsNew() === false) {
				self.LocationObject().Data.CountryURI(selectedObject.Data.URI());
			}
			else {
				self.LocationObject().Data._country_NewObjectId(selectedObject.Data.InternalObjectId());
			}
		...
		this.rebindLookups = function() {
			var relatedCountry = self.LocationObject().getCountry();
			var relatedCountry_RelatedElementDisplayField = self.LocationObject().getCountry() === null ? null : self.LocationObject().getCountry().Data.Name();
