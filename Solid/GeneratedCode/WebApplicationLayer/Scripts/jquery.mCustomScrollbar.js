...
/*scroll buttons*/
        ...
        update: function() {
            ...
            $("#" + $this.data("containerId")).find(".grid-header-wrapper").removeClass("mCS_no_scrollbar");
            $("#" + $this.data("containerId")).find(".grid-header-filler").removeClass("mCS_no_scrollbar");
            ...
            if (mCSB_containerH > mCustomScrollBoxH && !$this.data("horizontalScroll")) { /*content needs vertical scrolling*/
                ...
                $("#" + $this.data("containerId")).find(".grid-header-wrapper").addClass("mCS_no_scrollbar");
                $("#" + $this.data("containerId")).find(".grid-header-filler").addClass("mCS_no_scrollbar");
