...
<!DOCTYPE html>
  ...
  <head>
    ...
    <script src="30/scripts/jquery.cookie.js"></script>
    ...
    <script src="30/scripts/sidr.min.js"></script>
    <script src="30/namespaces.js"></script>
    ...
    <script src="30/Custom/Application/SourceHandler.custom.js"></script>
    <script src="30/Custom/Application/Routes.custom.js"></script>
    <script src="30/Custom/Application/ApplicationViewModel.custom.js"></script>
    <script src="30/Custom/ViewModels.js"></script>
    <script src="30/Custom/PageControllers.js"></script>
    <script src="30/Custom/EntityFactories.js"></script>
    <script src="30/Custom/EntityValidators.js"></script>
    <script src="30/Model/DataStores/DataMapper.js"></script>
    <script src="30/Application/ApplicationViewModel.js"></script>
    <script src="30/Model/DataStores/DataStore.js"></script>
    <script src="30/Model/DataSets/ObjectsDataSet.js"></script>
    <script src="30/ViewModels/Common/NoticeBoxViewModel.js"></script>
    <script src="30/ViewModels/Common/DialogPopupViewModel.js"></script>
    <script src="30/Widgets/datagrid.js"></script>
    <script src="30/Widgets/paginator.js"></script>
    <script src="30/Custom/CustomFields.js"></script>
    <script src="30/ViewModels/Common/ImagePopupViewModel.js"></script>
  </head>
  <body onunload="">
    <div id="form"></div>
  </body>
