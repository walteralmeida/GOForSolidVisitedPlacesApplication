...
<html>
  <head>
    ...
    <script src="31/scripts/jquery.cookie.js"></script>
    ...
    <script src="31/scripts/sidr.min.js"></script>
    <script src="31/namespaces.js"></script>
    ...
    <script src="31/Custom/Application/SourceHandler.custom.js"></script>
    <script src="31/Custom/Application/Routes.custom.js"></script>
    <script src="31/Custom/Application/ApplicationViewModel.custom.js"></script>
    <script src="31/Custom/ViewModels.js"></script>
    <script src="31/Custom/PageControllers.js"></script>
    <script src="31/Custom/EntityFactories.js"></script>
    <script src="31/Custom/EntityValidators.js"></script>
    <script src="31/Model/DataStores/DataMapper.js"></script>
    <script src="31/Application/ApplicationViewModel.js"></script>
    <script src="31/Model/DataStores/DataStore.js"></script>
    <script src="31/Model/DataSets/ObjectsDataSet.js"></script>
    <script src="31/ViewModels/Common/NoticeBoxViewModel.js"></script>
    <script src="31/ViewModels/Common/DialogPopupViewModel.js"></script>
    <script src="31/Widgets/datagrid.js"></script>
    <script src="31/Widgets/paginator.js"></script>
    <script src="31/Custom/CustomFields.js"></script>
    <script src="31/ViewModels/Common/ImagePopupViewModel.js"></script>
  </head>
  <body onunload="">
    <div id="form"></div>
  </body>
