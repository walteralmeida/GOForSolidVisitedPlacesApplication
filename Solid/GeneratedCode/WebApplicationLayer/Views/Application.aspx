...
<html>
  <head>
    ...
    <script src="43/scripts/jquery.cookie.js"></script>
    ...
    <script src="43/scripts/sidr.min.js"></script>
    <script src="43/namespaces.js"></script>
    ...
    <script src="43/Custom/Application/SourceHandler.custom.js"></script>
    <script src="43/Custom/Application/Routes.custom.js"></script>
    <script src="43/Custom/Application/ApplicationViewModel.custom.js"></script>
    <script src="43/Custom/ViewModels.js"></script>
    <script src="43/Custom/PageControllers.js"></script>
    <script src="43/Custom/EntityFactories.js"></script>
    <script src="43/Custom/EntityValidators.js"></script>
    <script src="43/Model/DataStores/DataMapper.js"></script>
    <script src="43/Application/ApplicationViewModel.js"></script>
    <script src="43/Model/DataStores/DataStore.js"></script>
    <script src="43/Model/DataSets/ObjectsDataSet.js"></script>
    <script src="43/ViewModels/Common/NoticeBoxViewModel.js"></script>
    <script src="43/ViewModels/Common/DialogPopupViewModel.js"></script>
    <script src="43/Widgets/datagrid.js"></script>
    <script src="43/Widgets/paginator.js"></script>
    <script src="43/Custom/CustomFields.js"></script>
    <script src="43/ViewModels/Common/ImagePopupViewModel.js"></script>
  </head>
  <body onunload="">
    <div id="form"></div>
  </body>
