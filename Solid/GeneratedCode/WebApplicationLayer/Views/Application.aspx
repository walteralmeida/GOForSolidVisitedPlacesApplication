...
<!DOCTYPE html>
  ...
  <head>
    ...
    <script src="26/scripts/jquery.cookie.js"></script>
    ...
    <script src="26/scripts/sidr.min.js"></script>
    <script src="26/namespaces.js"></script>
    ...
    <script src="26/Custom/Application/SourceHandler.custom.js"></script>
    <script src="26/Custom/Application/Routes.custom.js"></script>
    <script src="26/Custom/Application/ApplicationViewModel.custom.js"></script>
    <script src="26/Custom/ViewModels.js"></script>
    <script src="26/Custom/PageControllers.js"></script>
    <script src="26/Custom/EntityFactories.js"></script>
    <script src="26/Custom/EntityValidators.js"></script>
    <script src="26/Model/DataStores/DataMapper.js"></script>
    <script src="26/Application/ApplicationViewModel.js"></script>
    <script src="26/Model/DataStores/DataStore.js"></script>
    <script src="26/Model/DataSets/ObjectsDataSet.js"></script>
    <script src="26/ViewModels/Common/NoticeBoxViewModel.js"></script>
    <script src="26/ViewModels/Common/DialogPopupViewModel.js"></script>
    <script src="26/Widgets/datagrid.js"></script>
    <script src="26/Widgets/paginator.js"></script>
    <script src="26/Custom/CustomFields.js"></script>
    <script src="26/ViewModels/Common/ImagePopupViewModel.js"></script>
  </head>
  <body onunload="">
    <div id="form"></div>
  </body>
