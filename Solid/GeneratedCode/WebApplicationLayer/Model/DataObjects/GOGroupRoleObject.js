...
(function () {
	...
	/// </summary>
	Solid.Web.Model.DataObjects.GOGroupRoleObject = function(rootobject) {
		var self = this;
		
		this._objectType = "GOGroupRole";
		...
		// Computed
		this.ko_computed.push(this.Data.PrimaryKey = ko.pureComputed(ComputedPKForGOGroupRole, this));
		...
		this.StatusData = {
			...
			isGOGroupRoleEntityValid: ko.observable(true),
			gOGroupRoleEntityErrorMessage: ko.observable(null),
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.toString = function() {
	...
	// DateTime handling
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.setDateTimeFromJSON = function(prop, date) {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.addOnPropertyChangedHandler = function( handler ) {
		this.onPropertyChangedHandlers.push(handler);
	};

	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.removeOnPropertyChangedHandler = function( handler ) {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.onPropertyChanged = function (propertyName, callers) {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.getGroup = function () {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.setGroup = function (valueToSet, notifyChanges, dirtyHandlerOn) {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.getRole = function () {
		if (!this.ObjectsDataSet)
            return null;
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.setRole = function (valueToSet, notifyChanges, dirtyHandlerOn) {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.runValidation = function () {
		Solid.Web.Model.DataObjects.Validation.GOGroupRoleValidator.validate(this);
	};

	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.resetValidation = function () {
		Solid.Web.Model.DataObjects.Validation.GOGroupRoleValidator.resetValidation(this);
	};
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.Clone = function() {
		var clone = new Solid.Web.Model.DataObjects.GOGroupRoleObject();
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.CopyValuesFrom = function(sourceObject) {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.updateDependentCustomValues = function () {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.updateDependentValues = function() {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.initialize = function() {
	...
	Solid.Web.Model.DataObjects.GOGroupRoleObject.prototype.release = function() {			
		if (this.IsReleased)
			return;
	...
	function ComputedPKForGOGroupRole() {
		return { "id1": this.Data.GOGroupName(), "id2": this.Data.GORoleName() };
	}	 
	
	function statusDataValidationComputed() {
		var isValid = true;
		isValid = isValid && this.StatusData.isGroupValid() && this.StatusData.isRoleValid();
		return isValid;
	}
	...
	function GOGroupNamePropertySubscriptionHandler(newValue) {
		...
		if (this.Data.IsNew() === false && !this.isDataSetCopy && this.Data.GOGroupName_OldValue() !== newValue) {
			if (this.ObjectsDataSet) {
				this.ObjectsDataSet.getGOGroupRoleObjectsDataSet().gOGroupRoleObjectInternalIds[newValue] = this.ObjectsDataSet.getGOGroupRoleObjectsDataSet().gOGroupRoleObjectInternalIds[this.Data.GOGroupName_OldValue()];
				delete this.ObjectsDataSet.getGOGroupRoleObjectsDataSet().gOGroupRoleObjectInternalIds[this.Data.GOGroupName_OldValue()];
			}
		}
		
		if (this.Data.GOGroupName_OldValue() !== newValue && this.ObjectsDataSet) {
			this.ObjectsDataSet.getGOGroupRoleObjectsDataSet().UpdateGroupFKIndex(this.Data.GOGroupName_OldValue(), newValue, this);            
		}
	...
	function GORoleNamePropertySubscriptionHandler(newValue) {
		...
		if (this.Data.IsNew() === false && !this.isDataSetCopy && this.Data.GORoleName_OldValue() !== newValue) {
			if (this.ObjectsDataSet) {
				this.ObjectsDataSet.getGOGroupRoleObjectsDataSet().gOGroupRoleObjectInternalIds[this.Data.GOGroupName()][newValue] = this.ObjectsDataSet.getGOGroupRoleObjectsDataSet().gOGroupRoleObjectInternalIds[this.Data.GOGroupName()][this.Data.GORoleName_OldValue()];
				delete this.ObjectsDataSet.getGOGroupRoleObjectsDataSet().gOGroupRoleObjectInternalIds[this.Data.GOGroupName()][this.Data.GORoleName_OldValue()];
			}
		}
		
		if (this.Data.GORoleName_OldValue() !== newValue && this.ObjectsDataSet) {
			this.ObjectsDataSet.getGOGroupRoleObjectsDataSet().UpdateRoleFKIndex(this.Data.GORoleName_OldValue(), newValue, this);            
		}
    ...
    Solid.Web.Model.DataObjects.GOGroupRoleObjectFactory = {
        createNew: function (objectsDataSet, contextId) {
            // if there is a custom implementation => call it
			if (Solid.Web.Model.DataObjects.GOGroupRoleObjectFactoryCustom) {
                return Solid.Web.Model.DataObjects.GOGroupRoleObjectFactoryCustom.createNew(objectsDataSet, contextId);
            }
            else {
                var newObject = new Solid.Web.Model.DataObjects.GOGroupRoleObject();
	...
	if (window.ApplicationSourceHandler)
		window.ApplicationSourceHandler.onSourceLoaded("/Model/DataObjects/GOGroupRoleObject.js");
