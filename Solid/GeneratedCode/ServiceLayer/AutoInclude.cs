...
namespace Solid.ServiceLayer.IncludeMapping
{
	public partial class AutoInclude : IAutoInclude
	{
		...
		private Dictionary< string, string[] > _map = new Dictionary< string, string[] >
		{
			...
			// 
			// LocationForm 
			{  "auto-include-id-606f7503-3674-4cc6-b5f5-2589d2231be2", new string[] {  } },
			// UserProfileForm 
			...
			// UserProfileForm1 
			{  "auto-include-id-85969c33-eb46-4e7f-a83a-6ce36001722c", new string[] {  } },
			// PlaceToLocationForm 
			...
			// VisitedPlaceForm 
			{  "auto-include-id-4f98d10b-88f5-430f-8f3e-ce855171c63b", new string[] { "Place", "Country" } },
		};
	}
}
