...
{
	public partial class GOUserService : QueryParamCollection, IDataProvider<GOUserDataObject>
    {	
		...
		static string _serviceUrl = String.Format("{0}/dataset/api/{1}/", BaseUrl.TrimEnd('/'), "gouser");		
